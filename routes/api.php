...
Route::middleware(['auth:sanctum'])->group(function () {
  ...
  Route::get('/user-applications', [ApplicationApiController::class, 'user_applications']);
  Route::get('/funding-phases/{appid}', [ApplicationApiController::class, 'funding_phases']);
  Route::get('/repayments/{appid}', [ApplicationApiController::class, 'repayments']);

    Route::post('/search-items', [ApplicationApiController::class, 'search_items']);
    Route::get('/local-gov-areas', [ApplicationApiController::class, 'local_gov_areas']);

    Route::get('/view-documents/{appid}', [ApplicationApiController::class, 'view_documents']);
    Route::delete('/delete-document/{docid}', [ApplicationApiController::class, 'delete_document']);

    Route::post('/submit-repayment', [ApplicationApiController::class, 'submit_repayment']);

    Route::get('/delete-account', [ApplicationApiController::class, 'delete_account']);
