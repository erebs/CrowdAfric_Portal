    ...
    <div class="modal-content" style="border:none;">
      ...
      <div class="modal-body">
        <form class="edit-content" id="reject" method="post">
          ...
          <h6>Mail Id : <span id="sp9"></span></h3>
                ...
                <table id="example1" class="table table-striped">
                  ...
                  <tbody>
                    ...
                    @php
                     ...
                     $app=DB::table('applications')->where('user_id',$u->id)->where('status','!=','Cancelled')->count();
                     if($u->country_id=='')
                     {
                      $con='';
                     }
                  ...
                  <tr>
                   ...
                   <td>
                    ...
                    <a style="cursor: pointer;background-color: #dd778c;border:none;" onclick="UserProfile('{{$u->age}}','{{$u->address}}','{{$con}}','{{$st}}','{{$u->town}}','{{$u->community}}','{{$u->post_code}}','{{$u->email_id}}')" class="btn btn-danger btn-sm"><b> Profile</b></a>
                    @if($u->status=='Active')
                    ...
                    @endif
                     <a style="cursor: pointer;background-color: #28e653;border:none;" href='/user-applications/{{encrypt($u->id)}}' target="_blank" class="btn btn-danger btn-sm"><b> Applications</b></a>
...
<script>
   ...
   function UserProfile(age,add,con,dist,town,com,post,mail)
{
