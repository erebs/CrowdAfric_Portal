	...
	<div class="container-main">
		...
		<div class="col-lg-12 mb-3">
			...
			<form class="funding-form">
				...
				<div class="col-lg-12">
					<div class="form-group">
						<div id="selectplaceholder" class="selectPlaceHolder" >Local Government Area</div>
						<select class="form-control" id="local_area" onchange="GetArea(this.value)">
  ...
  <input type="file" class="form-control" name="pdf_file" id="pdf_file" />
				...
				<div class="col-lg-12">
					<div class="add-nominee-dv">
						...
						<p>Ensure you have consulted your guarantors</p>
					</div>
				</div>
			</form>
		</div>
...
btn1 = document.getElementById("selectplaceholder");
sel = document.getElementById("local_area");
...
function GetArea(val)
    {
    	if(val!='')
    	{
    		$('#selectplaceholder').addClass('selectValue');
    		var local_area=$("#local_area option:selected").text();
    		$('#selectplaceholder').text(local_area);
    		$('#selectplaceholder').removeClass('selectPlaceHolder');
    	}
    	else
    	{
    		$('#selectplaceholder').addClass('selectPlaceHolder');
    		$('#selectplaceholder').text('Local Government Area')
    		$('#selectplaceholder').removeClass('selectValue');
    	}
...
$('#ab2').hide();
    ...
    var local_area=$('#local_area option:selected').val();
          if(local_area=='')
      {
        $('#local_area').css('border','1px solid red');
        $('#local_area').focus();
        return false;
      }
      else
        $('#local_area').css('border','1px solid #000');
