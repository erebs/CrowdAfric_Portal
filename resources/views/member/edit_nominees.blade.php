...
@section('content')
	...
	<!-------------------------- -->
<br>
<div class="container"><p>Ensure you have consulted your guarantors</p></div>
				...
				<div class="form-group">
					<div class="col-lg-12">
						<div class="form-main-dv-nominee">
							<input type="hidden" class="form-control" id="nid{{$i}}" placeholder="nid" value="{{$n->id}}">
							<input type="text" class="form-control" id="n{{$i}}" placeholder="Name" value="{{$n->name}}">
							<i class="ri-edit-2-line"></i>
						</div>
					</div>
					<div class="col-lg-12">
						<div class="form-main-dv-nominee">
							<input type="number" class="form-control" id="m{{$i}}" placeholder="Mobile Number" value="{{$n->mobile}}">
							<i class="ri-edit-2-line"></i>
						</div>
					</div>
				</div>
...
$('#ab2').hide();
     ...
     var n5=$('input#n5').val();
      ...
      var nid1=$('input#nid1').val();
      var nid2=$('input#nid2').val();
      var nid3=$('input#nid3').val();
      var nid4=$('input#nid4').val();
      var nid5=$('input#nid5').val();
     ...
     $('#ab1').hide();
      ...
      data.append('m4', m4);
      data.append('m5', m5);
      data.append('nid1', nid1);
      data.append('nid2', nid2);
      data.append('nid3', nid3);
      data.append('nid4', nid4);
      data.append('nid5', nid5);
