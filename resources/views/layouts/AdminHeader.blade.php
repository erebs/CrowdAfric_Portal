...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link" data-widget="pushmenu" href="#" role="button" style="background: linear-gradient(359deg,#d11409,#d11409);border-radius: 100px;color: white;"><i class="fas fa-bars"></i></a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
       @if(Auth::guard('admin')->user()->profile_image=='image')
      <a href="/admin-profile" class="nav-link"><img src="{{ asset('default/default.jpg')}}" class="img-circle" style="width: 35px;">  {{Auth::guard('admin')->user()->name}}</a>
      @else
<a href="/admin-profile" class="nav-link"><img src="{{ asset('admin/img/'.Auth::guard('admin')->user()->profile_image)}}" class="img-circle" style="width: 35px;">  {{Auth::guard('admin')->user()->name}}</a>
  ...
  border-radius: 15%;
  background: linear-gradient(359deg,#d11409,#d11409);
  padding: 8px;
  color: white;">
