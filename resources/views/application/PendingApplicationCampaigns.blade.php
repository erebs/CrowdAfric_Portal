              ...
              <div class="card-body">
                <table id="example1" class="table table-striped">
                  ...
                  <tbody>
                    ...
                    $cnt1=DB::table('applications')->where('campaign_id',$u->id)->where('status','Started')->count();
                    $cnt2=DB::table('applications')->where('campaign_id',$u->id)->where('status','Submitted')->count();
                    $cnt3=DB::table('applications')->where('campaign_id',$u->id)->where('status','On Hold')->count();
                    @endphp
                    
                  <tr>
                    <td>{{$loop->iteration}}</td>
                     <td>{{$u->title}}<br>( {{$u->status}} )</td>
                  ...
                  <td>
                    ...
                    <a href="/pending-applications/{{encrypt($u->id)}}" target="_blank" style="cursor: pointer;background-color: #dd778c;border:none;" class="btn btn-danger btn-sm"><b> View</b></a>
