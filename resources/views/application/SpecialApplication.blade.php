            ...
            <div class="col-10 col-md-10 col-lg-4 order-1 order-md-2">
               <div class="card card-info">
                    ...
                    <div class="card-body card-block-a">
                        ...
                        <form action="/special-application-search" method="post" target="_blank">
                          @csrf
              ...
              <ul class="list-unstyled">
                ...
                <li>
    <i class="fa fa-dot-circle" aria-hidden="true" style="font-size: 10px;"></i>  <a href="/special-applications/{{encrypt($c->id)}}" class="btn-link text-primary"> {{$c->title}}</a>
                </li>
              @endforeach  
