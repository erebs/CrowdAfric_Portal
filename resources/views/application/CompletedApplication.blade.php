              ...
              <div class="row">
                <div class="col-11"><br>
                  ...
                  <tr>
                    ...
                    <!-- <td>{{$v->status}}</td> -->
                    <td><a href="/completed-appdetails/{{encrypt($v->id)}}" target="_blank" style="cursor: pointer;background-color: #dd778c;border:none;" class="btn btn-danger btn-sm"><b> View</b></a></td>
            ...
            <div class="col-10 col-md-10 col-lg-4 order-1 order-md-2">
              <div class="card card-info">
                    ...
                    <div class="card-body card-block-a">
                        ...
                        <form action="/completed-application-search" method="post" target="_blank">
                          @csrf
              ...
              <ul class="list-unstyled">
                ...
                <li>
    <i class="fa fa-dot-circle" aria-hidden="true" style="font-size: 10px;"></i>  <a href="/completed-applications/{{encrypt($c->id)}}" class="btn-link text-primary"> {{$c->title}}</a>
                </li>
              @endforeach  
