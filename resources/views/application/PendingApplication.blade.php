  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Approval Pending Applications</h1>
          </div>
          <div class="col-sm-6">
              ...
              <div class="row">
                <div class="col-10 col-sm-4">
                  <div class="info-box bg-c-green">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-text text-center text-white">Started Applications</span>
                    </div>
                ...
                <div class="col-10 col-sm-4">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-text text-center text-white">Submitted Applications</span>
                    </div>
                  </div>
                ...
                <div class="col-10 col-sm-4">
                  <div class="info-box  bg-c-blue">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-number text-center text-white mb-0 size-lg">{{$cnt3}}</span>
                      <span class="info-box-text text-center text-white">On Hold Applications</span>
                    </div>
                  </div>
            ...
            <div class="col-10 col-md-10 col-lg-4 order-1 order-md-2">
                <div class="card card-info">
                    ...
                    <div class="card-body card-block-a">
                        ...
                        <form action="/pending-applications-search" method="post" target="_blank">
                          @csrf
              ...
              <ul class="list-unstyled">
                ...
                <li>
    <i class="fa fa-dot-circle" aria-hidden="true" style="font-size: 10px;"></i>  <a href="/pending-applications/{{encrypt($c->id)}}" class="btn-link text-primary"> {{$c->title}}</a>
                </li>
              @endforeach  
