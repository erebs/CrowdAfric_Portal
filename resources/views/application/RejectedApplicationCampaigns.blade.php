              ...
              <div class="card-body">
                <table id="example1" class="table table-striped">
                  ...
                  <tbody>
                    ...
                    $cnt1=DB::table('applications')->where('campaign_id',$u->id)->where('status','Rejected')->count();
                    @endphp
                  ...
                  <td>
                    ...
                    <a href="/rejected-applications/{{encrypt($u->id)}}" target="_blank" style="cursor: pointer;background-color: #dd778c;border:none;" class="btn btn-danger btn-sm"><b> View</b></a>
