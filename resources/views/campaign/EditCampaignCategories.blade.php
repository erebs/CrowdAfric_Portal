            ...
            <div class="row">
              <div class="col-md-6">
                 ...
                 <div class="form-group">
                  <label>Title *</label>
                  <input type="text" name="title" id="title" class="form-control" value="{{$cat->title}}">
                </div>

                 <div class="form-group">
                  <label>Description *</label>
                  <textarea class="form-control ckeditor" rows="5" cols="5" id="desc">{{$cat->description}}</textarea>
                </div>
...
success:function(data)
{
  if(data['success'])
  {
    ...
    swal({
                          ...
                          .then((willDelete) => {
                           if (willDelete) {
                                 window.location.href='/campaign-categories';
                                      } 
