          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Fee (₦) *</label>
                  <input type="number" name="fee" id="fee" class="form-control" value="1">
                </div>

                 <div class="form-group">
                  <label>Description *</label>
                  <textarea class="form-control ckeditor" rows="3" cols="3"  id="desc"></textarea>
                </div>
                <div class="form-group">
                  <label>Content 1</label>
                  <textarea class="form-control ckeditor" rows="3" cols="3"  id="desc1"></textarea>
                </div>
              ...
              <div class="col-md-6">
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control ckeditor" rows="3" cols="3" id="desc2"></textarea>
                </div>
